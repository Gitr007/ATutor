...
CREATE TABLE `forums_threads` (
  ...
  `member_id` mediumint(8) unsigned NOT NULL default '0',
  `forum_id` mediumint(8) unsigned NOT NULL default '0',
  `last_comment` TIMESTAMP NOT NULL DEFAULT '2020-01-01 00:00:01',
...
CREATE TABLE `members` (
  ...
  `last_login` TIMESTAMP NOT NULL DEFAULT '2020-01-01 00:00:01',
  PRIMARY KEY  (`member_id`),
...
CREATE TABLE `tests_results` (
  ...
  `status` TINYINT NOT NULL DEFAULT '0',
  `end_time` TIMESTAMP NOT NULL DEFAULT '2020-01-01 00:00:01' ,
...
CREATE TABLE `social_groups` (
  ...
  `last_updated` TIMESTAMP NOT NULL DEFAULT '2020-01-01 00:00:01',
  PRIMARY KEY (`id`)
) ENGINE = MyISAM;
...
CREATE TABLE `basiclti_tools` (
	...
	`timemodified` TIMESTAMP NOT NULL DEFAULT '2020-01-01 00:00:01',
